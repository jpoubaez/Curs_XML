...
function zt(a,b){}var Z={b:{}};Z.b.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.g="ctv";Z.__ctv.h=!0;Z.__ctv.priorityOverride=0})(function(){return"411"})}();
...
"set",t);f(g+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(g+"require","render");a||(a=!0,R(r,function(){return Ek().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=T("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-59XCR9"])&&(v[b.vtp_optimizeContainerId]=!0)}else N(b.vtp_gtmOnFailure)})}();
